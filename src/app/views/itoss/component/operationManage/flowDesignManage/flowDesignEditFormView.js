...
var FlowDesignFormViewv = React.createClass({
    ...
    //  this.getFlux().actions.YFTFlowDesignActions.get_flowDesignPicData();
      ...
      $("#roleListTable thead>tr").css({"background": "#d8e1e5"});
      $("#stateListTable thead>tr").css({"background": "#d8e1e5"});
    },
    ...
    render:function(){
      ...
      // </fieldset>
        ...
        return(
            <div id='createOperationForm1' className='overviewDesViewDiv' style={{"width":"56%","margin":"16px auto","padding":"0 26px 0 25px","background":"#ffffff"}}>
