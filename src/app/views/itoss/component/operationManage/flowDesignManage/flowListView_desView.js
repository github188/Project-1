...
function queryFormatter(value, row) {
    return [
        '<a class="queryFlow" href="javascript:void(0)"><img src="img/images/search_03.png"/></a>'
    ].join('');
}

function editFormatter(value, row) {
    return [
        '<a class="editFlow" href="javascript:void(0)"><img src="img/images/系统-1用户管理_08.png"/></a>'
    ].join('');
}

function deleteFormatter(value, row) {
    return [
        '<a class="deleteFlow" href="javascript:void(0)"><img src="img/images/系统-1用户管理_03.png"/></a>'
    ].join('');
}
...
var FlowListView_desView = React.createClass({
    ...
    showFlowInfo: function(row, element){
        ...
        this.props.set_flowOnlyShow(1);//只读
        ...
        for(var i=0;i<modeData.length;i++){
          if("0" == modeData[i].t_type){
            ...
            oData.push({id:modeData[i].RecId,name:modeData[i].t_name});
				...
				$("#gdztmb").find(".rw-input").text("请选择");
				$("#clbd").find(".rw-input").text("请选择");
      }
        return (
            <div id='flowListView_desView' className='overviewDesViewDiv userListView_desView'>
                          ...
                          <div style={{marginTop:"8"}}>
                            <div className="col-md-6 col-sm-6" style={{paddingLeft:"0",paddingRight:"0"}}>
                              <div className="input-group">
                                ...
                                <ReactWidgets.DropdownList data={mData} textField='name' id="gdztmb" className="form-control col-sm-4"/>
                              </div>
                            </div>
                            <div className="col-md-6 col-sm-6" style={{paddingLeft:"0",paddingRight:"0"}}>
                              <div className="input-group">
                                <span className="input-group-addon">处理表单</span>
                                <ReactWidgets.DropdownList data={oData}  textField='name' id="clbd" className="form-control col-sm-4"/>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div className='operationCreateTableDiv col-md-12' style={{"margin-top":"-44px"}}>
