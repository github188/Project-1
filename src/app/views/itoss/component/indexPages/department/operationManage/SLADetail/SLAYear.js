...
import ProjectSLA from './SLAYear/projectSLA';
import UnitSLA from './SLAYear/unitSLA';
import EngineerSLA from './SLAYear/engineerSLA';
				    			 	...
				    			 	<nav className='navFauleManger'>
				    			 		              <div className='usermanagerNavLeft'>
					    			 		        	    <div className='fauleMangerline'><span></span></div>
						    							  	<div className='txtFauleMangerleft'>年SLA达成率</div>		   									   
					    							  </div>	 	
				    			 	</nav>
