...
var SatisfactionScoreQuarter = React.createClass({
    ...
    $('#containerScoreQuarter').highcharts({
        chart: {
            type: 'bar'
        },
        xAxis: {
	  ...
	  render:function() {
	    return (
	    		<div className='completionUnitTopToady'>
                        <div  id="containerScoreQuarter" style={{"width": "100%", "height": "310px","margin":"0 auto"}}></div>
			    </div>				
	  )},
	});
...
export default connect(mapStateToProps)(SatisfactionScoreQuarter)
