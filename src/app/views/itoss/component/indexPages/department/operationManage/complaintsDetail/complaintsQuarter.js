...
var ComplaintsQuarterDetail = React.createClass({
	    componentDidMount:function(){
					$(".unitSLAfaultClick").css({'color':'#349ef0','borderBottom':'4px solid #349ef0'})		
	                },
	  	componentDidUpdate:function(){
          var bdata = this.props.customerComplaintsData;
          console.log("complaintsDataUintQuarter")
          console.log(bdata)
    	 $("#complaintsDataUintQuarter>thead>tr").css({"background":"#daf1f8"});
          $("#complaintsDataUintQuarter").bootstrapTable("load",bdata);
                },
    componentDidMount: function () {
	$(".unitSLAfaultClick").css({'color':'#349ef0','borderBottom':'4px solid #349ef0'})
        $("#complaintsDataUintQuarter").bootstrapTable({
            columns: [
	         {
			            title: '单位名称',
			            field: 'FDNAME',
				       ...
				       <section className='sectionFauleManger'>
				    			 	<nav className='navFauleManger'>
				    			 		              <div className='usermanagerNavLeft'>
					    			 		        	    <div className='fauleMangerline'><span></span></div>
						    							  	<div className='txtFauleMangerleft'>季度投诉量</div>		   									   
					    							  </div>	 	
				    			 	</nav>
				    			 	...
				    			 	<div className=''>
				    			 	   <div className="col-md-12">
						                    <table id="complaintsDataUintQuarter"
						                           data-toggle='table'
						                           data-search='false'
...
//		  }
//		}
//export default connect(mapStateToProps)(ComplaintsQuarterDetail)
export default ComplaintsQuarterDetail