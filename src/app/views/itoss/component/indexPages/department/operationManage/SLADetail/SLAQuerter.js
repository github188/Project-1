...
import ProjectSLA from './SLAQuerter/projectSLA';
import UnitSLA from './SLAQuerter/unitSLA';
import EngineerSLA from './SLAQuerter/engineerSLA';
import * as OperationManage from "../../../../../../../actions/operation_action";
import Store from '../../../../../../../server/store';
import { connect } from 'react-redux';
var PerformanceSLA = React.createClass({
				    			 	...
				    			 	<nav className='navFauleManger'>
				    			 		              <div className='usermanagerNavLeft'>
					    			 		        	    <div className='fauleMangerline'><span></span></div>
						    							  	<div className='txtFauleMangerleft'>季度SLA达成率</div>		   									   
					    							  </div>	 	
				    			 	</nav>
...
export default connect(mapStateToProps)(PerformanceSLA)