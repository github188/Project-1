...
import ProjectSatisfaction from './satisfactionYear/projectSatisfaction';
import UnitSatisfaction from './satisfactionYear/unitSatisfaction';
import EngineerSatisfaction from './satisfactionYear/engineerSatisfaction';
import * as OperationManage from "../../../../../../../actions/operation_action";
import Store from '../../../../../../../server/store';
import { connect } from 'react-redux';
var SatisfactionYearDetail = React.createClass({
...
//		  	customeSatisfactionScoreData=this.props.customeSatisfactionScoreData
	...
	toggle:function(page){
	          ...
	          var unit = 'unit'
			     ...
			     var paramProject = [project,year];
			     var paramEngineer = [engineer,year];
				switch(page){
				    			 	...
				    			 	<nav className='navFauleManger'>
				    			 		              <div className='usermanagerNavLeft'>
					    			 		        	    <div className='fauleMangerline'><span></span></div>
						    							  	<div className='txtFauleMangerleft'>年满意度评分</div>		   									   
					    							  </div>	 	
				    			 	</nav>
...
export default connect(mapStateToProps)(SatisfactionYearDetail)