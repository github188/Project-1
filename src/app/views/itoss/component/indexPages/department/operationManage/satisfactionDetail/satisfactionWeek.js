...
import ProjectSatisfaction from './satisfactionWeek/projectSatisfaction';
import UnitSatisfaction from './satisfactionWeek/unitSatisfaction';
import EngineerSatisfaction from './satisfactionWeek/engineerSatisfaction';
import * as OperationManage from "../../../../../../../actions/operation_action";
import Store from '../../../../../../../server/store';
import { connect } from 'react-redux';
var SatisfactionDetail = React.createClass({
...
//        console.log(bdata)
//    $("#satisfactionDataUintWeek").bootstrapTable("load",bdata);
//  },				
...
//		  	customeSatisfactionScoreData=this.props.customeSatisfactionScoreData
	...
	toggle:function(page){
	          ...
	          const { dispatch } = this.props;
			     ...
			     var paramProject = [project,week];
			     var paramEngineer = [engineer,week];
				switch(page){
				    			 	...
				    			 	<nav className='navFauleManger'>
				    			 		              <div className='usermanagerNavLeft'>
					    			 		        	    <div className='fauleMangerline'><span></span></div>
						    							  	<div className='txtFauleMangerleft'>周满意度评分</div>		   									   
					    							  </div>	 	
				    			 	</nav>
...
export default connect(mapStateToProps)(SatisfactionDetail)