...
import ProjectSLA from './SLAWeek/projectSLA';
import UnitSLA from './SLAWeek/unitSLA';
import EngineerSLA from './SLAWeek/engineerSLA';
				    			 	...
				    			 	<nav className='navFauleManger'>
				    			 		              <div className='usermanagerNavLeft'>
					    			 		        	    <div className='fauleMangerline'><span></span></div>
						    							  	<div className='txtFauleMangerleft'>周SLA达成率</div>		   									   
					    							  </div>	 	
				    			 	</nav>
