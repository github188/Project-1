...
var ComplaintsRankingYear = React.createClass({
			...
			var customerComplaintsData = this.props.customerComplaintsData;
             ...
             console.log(customerComplaintsData);
			     $(function () {
					    ...
					    $('#completionUnitTopYearid').highcharts({
					        chart: {
					            type: 'column'
					        },
					         title: {
		  ...
		  render: function() {
		    return (
							...
							<div id="completionUnitTopYearid"  style={{"width":"100%","height":"310px"}}></div>
...
//		  }
//		}
//export default connect(mapStateToProps)(ComplaintsRankingYear)

export default ComplaintsRankingYear