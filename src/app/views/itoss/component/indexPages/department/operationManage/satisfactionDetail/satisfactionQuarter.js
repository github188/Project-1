...
import ProjectSatisfaction from './satisfactionQuerter/projectSatisfaction';
import UnitSatisfaction from './satisfactionQuerter/unitSatisfaction';
import EngineerSatisfaction from './satisfactionQuerter/engineerSatisfaction';
import * as OperationManage from "../../../../../../../actions/operation_action";
import Store from '../../../../../../../server/store';
import { connect } from 'react-redux';
var SatisfactionQuarterDetail = React.createClass({
...
//		  	customeSatisfactionScoreData=this.props.customeSatisfactionScoreData
	          ...
	          const { dispatch } = this.props;
	            var unit = 'unit'
			     ...
			     var paramProject = [project,quarter];
			     var paramEngineer = [engineer,quarter];
				switch(page){
				    			 	...
				    			 	<nav className='navFauleManger'>
				    			 		              <div className='usermanagerNavLeft'>
					    			 		        	    <div className='fauleMangerline'><span></span></div>
						    							  	<div className='txtFauleMangerleft'>季度满意度评分</div>		   									   
					    							  </div>	 	
				    			 	</nav>
...
export default connect(mapStateToProps)(SatisfactionQuarterDetail)