...
const PurchaseHardInDetailView = React.createClass({
	mixins:[History],
	...
	render:function(){
	return(
        <div className="assetsHardInPurchaseDetail" style={{"width":"100%","height":"auto","padding-bottom":"32px","padding-top":"1px","backgroundColor":"#edf5f8"}}>
            <div className="assetsHardInPurchaseDetail_content" style={{"margin":"16px auto","height":"auto","width":"1016px","backgroundColor":"#ffffff","padding":"0 26px 0 25px"}}>
                <div className="hardInPurchaseDetail_head" style={{"width":"966px","borderBottom":"1px solid #ebecee","overflow":"hidden","position":"relative"}}>
                    <div className="hardInPurchaseDetail_head_left" style={{"width":"120px","height":"57px","borderBottom":"3px solid #349ff1","fontSize":"18px","lineHeight":"60px","textAlign":"center","color":"#349ff1"}}>
                        硬件采购入库详情
                    </div>
                    <div className="hardInPurchaseDetail_head_right" style={{"width":"60px","height":"32px","backgroundColor":"#ccc","color":"#333","lineHeight":"32px","textAlign":"center","borderRadius":"5px","position":"absolute","right":"0","top":"17px","cursor":"pointer"}} onClick={this.goBack}>返回</div>
                </div>
                <div className="hardInPurchaseDetail_content_middle" style={{"width":"966px","margin-top":"20px"}}>
                    <form className="form-horizontal" role="form">
                        <div className="hardInPurchaseDetail_content_middle_left" style={{"width":"424px","display":"inline-block","height":"776px"}}>
                        ...
                        <div className="hardInPurchaseDetail_content_middle_right" style={{"width":"424px","display":"inline-block","height":"776px","margin-left":"74px"}}>
                                <div className="form-group">
                ...
                <div className="hardInPurchaseDetail_content_bottom" style={{"width":"928px"}}>
                    <div className="hardInPurchaseDetail_content_middle_bottom" style={{"width":"966px"}}>
                        <div className="form-group">
...
//export default PurchaseHardInDetailView;
...
export default connect(myStateToProps)(PurchaseHardInDetailView);