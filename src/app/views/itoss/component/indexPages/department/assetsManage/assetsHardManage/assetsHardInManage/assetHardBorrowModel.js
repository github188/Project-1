...
const AssetHardBorrowModel = React.createClass({
	...
	componentDidUpdate:function () {
        ...
        $("#borrowNewTableModelList").bootstrapTable("load",bdata);
    },
	componentDidMount:function(){ 
  		   $("#borrowNewTableModelList").bootstrapTable({
            columns: [
	                  {
                    field: 'state',
                    checkbox: true
        ...
        $("#borrowNewTableModelList thead>tr").css({"background": "#daf1f8"});
        
    },
    selectAssetsInfo:function(){
    	const {dispatch} = this.props;
    	let rowIdArr = $("#borrowNewTableModelList").bootstrapTable("getSelections");
    	...
    	dispatch(assetAction.get_hardBorrowAssetOfCode(rowIdss));
    	$("#selectHardModal").modal("hide");
    },
	render:function(){
		return(
            <div className="assetsHardInBorrowAdd" style={{"width":"100%","height":"inherit","padding-bottom":"32px","padding-top":"1px","backgroundColor":"#edf5f8"}}>
            	...
            	<div style={{"width":"966px","margin-top":"10px"}}>
                    <table id="borrowNewTableModelList"
...
export default connect(myStateToProps)(AssetHardBorrowModel);
