...
let _this;
const PurchaseNewView = React.createClass({
		mixins: [History],
        ...
        $(document).ready(function() {
            var options = {
              ...
              valueChanged: function(val) {
                ...
                if(plus > oldPlus){
                    $("#addDevice").append('<div id = serial_'+plus+' class="form-group" ><label>序列号</label><div className="col-sm-6" style="display:inline;margin-left:86px;"><input type="text" id=serialNo_'+plus+' style="width:340px;height:34px;border:1px solid #ccc;border-radius:4px;"/></div></div>');
                    oldPlus = plus;    
                }else if(plus <oldPlus){
                    $('#serial_'+ oldPlus).remove();                
                    oldPlus = plus;
                }else if(plus == oldPlus ==0){
                    $('#serial_1 ').empty();
                    oldPlus = plus;
                }
                console.log("oldPlus"+oldPlus); 
               }     
            }
...
//		}
		filter.push({key: "BARCODE", value: barCode});
...
//		}
		...
		if(serialNum == null || serialNum.trim() == ""){
			...
			//如果不等于空，则判断开始判断增加设备的数量
			if(numAssets > 0){
				for(var i=0; i< numAssets; i++){
					var num = i+1;
					if(i == numAssets - 1){
						serialNum = serialNum + "," + $("#serialNo_" + num).val();
					}else{
						serialNum = serialNum + "," + $("#serialNo_" + num).val() + ",";
					}
...
//		}
		...
		const {dispatch} = this.props;
		dispatch(assetAction.save_hardWareStorageData(filter));
		if(parameter == "aa"){
	  		//保存并新增
			$("#projectNameSelect").find(".rw-input").text("请选择");
	    	$("#operatUnitSelect").find(".rw-input").text("请选择");
            ...
            <div className="assetsHardInPurchaseAdd" style={{"width":"100%","height":"auto","padding-bottom":"32px","padding-top":"1px","backgroundColor":"#edf5f8"}}>
                <div className="assetsHardInPurchaseAdd_content" style={{"margin":"16px auto","height":"auto","width":"1016px","backgroundColor":"#ffffff","padding":"0 26px 0 25px"}}>
                    <div className="assetsHardInPurchaseAdd_head" style={{"width":"966px","borderBottom":"1px solid #ebecee","overflow":"hidden","position":"relative"}}>
						...
						<div className="purchaseAdd_head_right" style={{"width":"60px","height":"32px","backgroundColor":"#ccc","color":"#333","lineHeight":"32px","textAlign":"center","borderRadius":"5px","position":"absolute","right":"0","top":"17px","cursor":"pointer"}} onClick={this.goBack}>返回</div>
                        ...
                        <div className="assetsHardInPurchaseAdd_head_right" style={{"width":"98px","height":"32px","border":"1px solid #74ce84","color":"#74ce84","lineHeight":"32px","textAlign":"center","borderRadius":"5px","position":"absolute","right":"132px","top":"17px","cursor":"pointer"}} onClick={this.saveAndAdd}>保存并新增</div>
                    </div>
                    <div className="assetsHardInPurchaseAdd_content_middle" style={{"width":"966px","margin-top":"20px"}}>
                        <form className="form-horizontal" role="form">
                            <div className="form-group" id="barCodeHardInPur" style={{"display":"none"}}>
                            ...
                            <div className="assetsHardInPurchaseAdd_content_middle_left" style={{"width":"424px","display":"inline-block","height":"776px"}}>
		                            ...
		                            <div className="form-group">
		                                <label htmlFor="barCode" className="col-sm-4 control-label" style={{"textAlign":"left"}}>条形码
		                                </label>
		                                <div className="col-sm-6">
		                                    <input type="text" style={{"width":"340px","margin-left":"-20px"}} id="barCode" className="form-control" name="barCode" placeholder=""/>
                            ...
                            <div className="assetsHardInPurchaseAdd_content_middle_right" style={{"width":"424px","display":"inline-block","height":"776px","margin-left":"74px"}}>
                                    <div className="form-group">
                    ...
                    <div className="assetsHardInPurchaseAdd_content_bottom" style={{"width":"928px","height":"auto"}}>
                        <div className="assetsHardInPurchaseAdd_content_bottom_top" style={{"width":"928px","height":"52px","lineHeight":"52px"}}>
                            <span style={{"display":"inline-block","border":"6px solid transparent","borderLeftColor":"#379eed"}}></span>
                           增加设备
                           <div className="wan-spinner wan-spinner-1" style={{"display":"inline-block","margin-left":"66px"}}>
                                <a href="javascript:void(0)" className="minus"><img src="./lib/WanSpinner/assetsHardPurchasedesc.png"/></a>
                                <input type="text" value="0" id="numAssets" style={{"margin":"0 8px","lineHeight":"28px"}}/>
                                <a href="javascript:void(0)" className="plus" onClick={this.addDiv} ><img src="./lib/WanSpinner/assetsHardIncrease.png" /></a> 
                            </div>
                        </div>
                        <div className="assetsHardInPurchaseAdd_content_middle_bottom" style={{"width":"966px","display":"inline-block"}}>
                        	<form>
                                <div id="addDevice"></div>               
                                <div className="form-group" style={{"display":"inline-block","margin-left":"2px","margin-top":"20px"}}>
                                    <label htmlFor="" className="col-sm-1 control-label" style={{"margin-left":"-15px"}}>备注</label>
...
function myStateToProps(state) {
  	const{projectData,brandData,locationData,magUnitData,productType,productChildType} = state.dataDictReducer;
  	const{organizationData} = state.systemReducer;
    return{
...
export default connect(myStateToProps)(PurchaseNewView);