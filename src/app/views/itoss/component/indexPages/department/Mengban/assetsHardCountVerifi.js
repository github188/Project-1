...
var _this = this;
var AssetsHardCountVerifi = React.createClass({
    ...
    componentDidMount:function(){ 
      $("#assetsHardVerifiList").bootstrapTable({
            columns: [
                {
                    title: '序号',
                    field: 'STATUSNAME',
      ...
      $("#assetsHardVerifiList thead>tr").css({ "background": "#d8e1e5" });
    },
    ...
    return (
            ...
            <div className="hardCounVerifi" >
                <form className="form-horizontal" role="form">
                    <div className="form-group"> 
                        <label for="" className="col-sm-2 control-label" style={{"left":"-58px"}}>核销单号</label> 
                    ...
                    <div className="form-group"> 
                        <label for="" className="col-sm-2 control-label" style={{"left":"-58px"}}>核销说明</label> 
...
export default connect(mapStateToProps)(AssetsHardCountVerifi)
