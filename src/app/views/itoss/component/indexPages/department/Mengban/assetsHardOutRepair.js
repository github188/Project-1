...
var _this = this;
var AssetsHardOutRepair = React.createClass({
    ...
    componentDidMount:function(){ 
      $("#hardOutRepairModelList").bootstrapTable({
            columns: [
                {
                    title: '序号',
                    field: 'STATUSNAME',
        ...
        $("#hardOutRepairModelList thead>tr").css({ "background": "#daf1f8" });
        $(".fixed-table-container ").css({"height":"300px","overflow":"auto"});
    },
render: function () {
    return (
        <div className="col-md-12 assetsHardOutRepairMod">
			<table id="hardOutRepairModelList"
			    data-toggle='table'
...
export default connect(mapStateToProps)(AssetsHardOutRepair)
