...
const Aindex = React.createClass({
	              getInitialState:function(){
					...
					componentWillMount:function(){
						      ...
						      var customerComplaintsData=this.props.customerComplaintsData
								...
								componentDidMount:function(){
									      var customeSatisfactionScoreData=this.props.customeSatisfactionScoreData
									       console.log('2222最终页面，首页 customeSatisfactionScoreData')
				   ...
				   $("#SatisfactionRankIndex0").html(customeSatisfactionScoreData[20].NAME) 
                   $("#SatisfactionRankIndex21").html(customeSatisfactionScoreData[1].NAME)  
                   $("#SatisfactionRankIndex22").html(customeSatisfactionScoreData[2].NAME)  
                   $("#SatisfactionRankIndex23").html(customeSatisfactionScoreData[3].NAME)  
                   $("#SatisfactionRankIndex24").html(customeSatisfactionScoreData[4].NAME)  
                   $("#SatisfactionRankIndex25").html(customeSatisfactionScoreData[5].NAME)  
                   $("#SatisfactionRankIndex26").html(customeSatisfactionScoreData[6].NAME)  
                   $("#SatisfactionRankIndex27").html(customeSatisfactionScoreData[7].NAME)        
										},
			    						...
			    						<p className='Satisfaction-ranking-top'></p>
												<div className ='Satisfaction-ranking-cnt'>
													<ul className='Satisfaction-ranking-cnt-left'>
															<li id="SatisfactionRankIndex20"></li>
															<li id="SatisfactionRankIndex21"></li>
															<li id="SatisfactionRankIndex22"></li>
															<li id="SatisfactionRankIndex23"></li>
															<li id="SatisfactionRankIndex24"></li>
															<li id="SatisfactionRankIndex25"></li>
															<li id="SatisfactionRankIndex26"></li>
															<li id="SatisfactionRankIndex27"></li>
													</ul>
