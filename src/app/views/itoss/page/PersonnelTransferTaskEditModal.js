...
var PersonnelTransferTaskEditModal = React.createClass({
    ...
    componentDidUpdate:function () {
        ...
        $("#personnelTransferTaskEditTableList").bootstrapTable("load",bdata);
    },
    componentWillMount:function(){

    },
    componentDidMount:function(){
        $("#personnelTransferTaskEditTableList").bootstrapTable({
            columns: [
                {
                    field:"state",
                    radio:true
    ...
    setRowTaskUserNameEdit:function () {
        const {dispatch} = this.props;
        let rowUserName = $("#personnelTransferTaskEditTableList").bootstrapTable("getSelections");
        let RowUser;
        let RowLoginId;
        let taskFlowAction;
        let taskFromId;
        ...
        $("#nextTaskUserClEdit").val(RowUser);
        $("#PersonnelTransferTaskEditModal").modal("hide");
    },
    render:function(){
        return (
            <div className="modal fade" id="PersonnelTransferTaskEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="col-md-12">
                                <table id="personnelTransferTaskEditTableList"
                                       data-toggle='table'
                        ...
                        <div className="modal-footer" style={{"borderTop":"none"}}>
                            <button type="button" className="btn btn-primary" style={{"marginTop":"20px"}} onClick={this.setRowTaskUserNameEdit}>确定</button>
...
module.exports =  connect(mapStateToProps)(PersonnelTransferTaskEditModal);
