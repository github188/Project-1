...
var PersonnelTransferTaskModal = React.createClass({
    ...
    componentDidUpdate:function () {
        ...
        $("#personnelTransferTaskTableList").bootstrapTable("load",bdata);
    },
    componentWillMount:function(){

    },
    componentDidMount:function(){
        $("#personnelTransferTaskTableList").bootstrapTable({
            columns: [
                {
                    field:"state",
                    radio:true
    ...
    setRowTaskUserName:function () {
        const {dispatch} = this.props;
        let rowUserName = $("#personnelTransferTaskTableList").bootstrapTable("getSelections");
        let RowUser;
        let RowLoginId;
        let taskFlowAction;
        let taskFromId;
        ...
        $("#nextTaskUserCl").val(RowUser);
        $("#PersonnelTransferTaskModal").modal("hide");
    },
    render:function(){
        return (
            <div className="modal fade" id="PersonnelTransferTaskModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="col-md-12">
                                <table id="personnelTransferTaskTableList"
                                       data-toggle='table'
                        ...
                        <div className="modal-footer" style={{"borderTop":"none"}}>
                            <button type="button" className="btn btn-primary" style={{"marginTop":"20px"}} onClick={this.setRowTaskUserName}>确定</button>
...
module.exports =  connect(mapStateToProps)(PersonnelTransferTaskModal);
