...
export const SET_HARDORSOFTWARESTATISTICSDATA= "SET_HARDORSOFTWARESTATISTICSDATA"
export const SET_SOFTWARESTATISTICSDATA= "SET_SOFTWARESTATISTICSDATA"
export const SET_SPAREPARTSDATA= "SET_SPAREPARTSDATA"
export const SET_HARDWAREOVERDUEASSETSDATA= "SET_HARDWAREOVERDUEASSETSDATA"
export const SET_SOFTWAREOVERDUEASSETSDATA= "SET_SOFTWAREOVERDUEASSETSDATA"
export const SET_HARDWAREFAULTRATEDATA= "SET_HARDWAREFAULTRATEDATA"
export const SET_HARDWARESTORAGEDATA = "SET_HARDWARESTORAGEDATA"
export const SET_HARDWARESTORAGEID = "SET_HARDWARESTORAGEID"
export const SET_HARDWARESTORAGECOUNT = "SET_HARDWARESTORAGECOUNT"
export const SET_HARDWARESELECTEDDATA = "SET_HARDWARESELECTEDDATA"
export const SET_HARDWARESELECTEBORROWDDATA = "SET_HARDWARESELECTEBORROWDDATA"
export const SET_HARDWAREDETAILDATA = "SET_HARDWAREDETAILDATA"
export const SET_HARDWARESELECTEREPAIRDATA = "SET_HARDWARESELECTEREPAIRDATA"
export const SET_ASSETCODE = "SET_ASSETCODE"
export const SET_HARDWAREINREVIEWDATA = "SET_HARDWAREINREVIEWDATA"
export const SET_GOBACK = "SET_GOBACK"
export const SET_VERIFYASSETSTATUS = "SET_VERIFYASSETSTATUS"
...
//刘家顺 20170211 保存获取的值
export function setHardOrSoftWareStatisticsData(hardOrSoftWareStatisticsData) {
    return {
        type: SET_HARDORSOFTWARESTATISTICSDATA,
        hardOrSoftWareStatisticsData
    }
}
export function setSoftWareStatisticsData(softWareStatisticsData) {
    return {
        type: SET_SOFTWARESTATISTICSDATA,
        softWareStatisticsData
    }
}
export function setSparePartsData(sparePartsData) {
    return {
        type: SET_SPAREPARTSDATA,
        sparePartsData
    }
}
export function setHardWareOverdueAssetsData(hardWareOverdueAssetsData) {
    return {
        type: SET_HARDWAREOVERDUEASSETSDATA,
        hardWareOverdueAssetsData
    }
}
export function setSoftWareOverdueAssetsData(softWareOverdueAssetsData) {
    return {
        type: SET_SOFTWAREOVERDUEASSETSDATA,
        softWareOverdueAssetsData
    }
}
export function setHardWareFaultRateData(hardWareFaultRateData) {
    return {
        type: SET_HARDWAREFAULTRATEDATA,
        hardWareFaultRateData
    }
}

//曹志强		20170213     硬件资产入库ACTION
export function setHardWarestorageData(hardWareStorageData){
    return {
        type: SET_HARDWARESTORAGEDATA,
        hardWareStorageData
    }
}
//曹志强		20170213     硬件资产入库ACTION
export function setHardWarestorageId(hardWareStorageId){
    return {
        type: SET_HARDWARESTORAGEID,
        hardWareStorageId
    }
}
//曹志强		20170213     硬件资产入库ACTION
export function setHardWarestorageCount(hardWareStorageCount){
    return {
        type: SET_HARDWARESTORAGECOUNT,
        hardWareStorageCount
    }
}
//曹志强		20170213     硬件资产入库ACTION
export function setHardWareSelectedData(hardWareSelectedData){
    return {
        type: SET_HARDWARESELECTEDDATA,
        hardWareSelectedData
    }
}
//曹志强		20170213     查看资产详情ACTION
export function setHardWareDetaildData(hardWareDetaildData){
    return {
        type: SET_HARDWAREDETAILDATA,
        hardWareDetaildData
    }
}
//曹志强		20170213     获取被选择资产借用入库ACTION
export function setHardWareSelectedBorrowData(hardWareSelectedBorrowData){
    return {
        type: SET_HARDWARESELECTEBORROWDDATA,
        hardWareSelectedBorrowData
    }
}
//曹志强		20170213     获取被选择硬件资产维修入库ACTION
export function setHardWareSelectedRepairData(hardWareSelectedRepairData){
    return {
        type: SET_HARDWARESELECTEREPAIRDATA,
        hardWareSelectedRepairData
    }
}
//曹志强		20170213     返回首页ACTION
...
//曹志强		20170213     返回首页ACTION
export function setAssetCode(assetCode){
    return {
        type: SET_ASSETCODE,
        assetCode
    }
}
//曹志强		20170213     审核传值ACTION
export function setHardWareInreviewData(hardWareInreviewData){
    return {
        type: SET_HARDWAREINREVIEWDATA,
        hardWareInreviewData
    }
}
//曹志强		20170213     审核传值ACTION
export function setVerifyAssetStatus(verifyAssetStatus){
    return {
        type: SET_VERIFYASSETSTATUS,
        verifyAssetStatus
    }
}
...
export function get_hardOrSoftWareStatisticsData() {
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		oData.getHardOrSoftWareStatisticsData(function(data){
			var results = data.results;
            dispatch(setHardOrSoftWareStatisticsData(results));
            dispatch(requestDataActions.setRequestSuccess());
		});
    }
}
export function get_softWareStatisticsData() {
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		oData.getSoftWareStatisticsData(function(data){
			var results = data.results;
            dispatch(setSoftWareStatisticsData(results));
            dispatch(requestDataActions.setRequestSuccess());
		});
    }
}

export function get_sparePartsData() {
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		oData.getSparePartsData(function(data){
			var results = data.results;
            dispatch(setSparePartsData(results));
            dispatch(requestDataActions.setRequestSuccess());
		});
    }
}
export function get_hardWareOverdueAssetsData() {
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		oData.getHardWareOverdueAssetsData(function(data){
			var results = data.results;
            dispatch(setHardWareOverdueAssetsData(results));
            dispatch(requestDataActions.setRequestSuccess());
		});
    }
}
export function get_softWareOverdueAssetsData() {
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		oData.getSoftWareOverdueAssetsData(function(data){
			var results = data.results;
            dispatch(setSoftWareOverdueAssetsData(results));
            dispatch(requestDataActions.setRequestSuccess());
		});
    }
}
// 刘家顺 20170216 硬件故障率统计表 图
export function get_hardWareFaultRateData(data){
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		var param = {DATATYPE:data[0]};
        oData.getHardWareFaultRateData(param,function(data2){
            dispatch(setHardWareFaultRateData(data2.results));
            dispatch(requestDataActions.setRequestSuccess());
        });
    }
}
//曹志强		20170206	获取硬件资产入库列表 
export function get_HardWareStorageData(param) {
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		oData.getHardWareStorageList(param,function(data){
			var results = data.results;
			if(results.length>0){
					var result = results[0].ASSETSINFO;
					var count = results[0].COUNT;
					var faults = eval(result);
	        dispatch(setHardWarestorageData(faults));
	        dispatch(setHardWarestorageId(""));
	        dispatch(setHardWarestorageCount(count));
	        dispatch(requestDataActions.setRequestSuccess());
			};
		});
    }
...
//曹志强		20170215	添加硬件资产入库导入
export function save_hardWareStorageData(data) {
    return (dispatch, getState) => {
        var state = getState();
//      var id = state.dataDictReducer.productTypeId;
	      dispatch(requestDataActions.setRequest());
				oData.addHardWareStorageData(data,dispatch,function(data2){
	      dispatch(requestDataActions.setRequestSuccess());
					setTimeout(function(){
...
//曹志强		20170206	删除硬件资产入库记录数据
export function delete_hardWareStorageData(param) {
    return (dispatch, getState) => {
    var state = getState();
		if(param == ""){
			param = state.assetManageReducer.hardWareStorageId;
		}
		if(param==null || param==""){
			setTimeout(function(){
				document.getElementById('publicMessageModelTitle').innerHTML = "提示"
				document.getElementById('publicMessageModalcontent').innerHTML = "请选择要删除的硬件资产入库记录"
				$('#publicMessageModal').modal('show');
			},100);
			return false;
		}
    dispatch(requestDataActions.setRequest());
		oData.deleteHardWareStorage(param,function(data2){
			dispatch(setHardWarestorageId(""));
			dispatch(get_HardWareStorageData());
      dispatch(requestDataActions.setRequestSuccess());
			setTimeout(function(){
				document.getElementById('publicMessageModelTitle').innerHTML = "提示"
...
//曹志强		20170206	获取硬件资产入库列表 
export function get_hardAssetOfCode(param) {
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		oData.getHardAssetOfCode(param,function(data){
			var results = data.results;
			if(results.length>0){
					var result = results[0].ASSETSINFO;
					var faults = eval(result);
	        dispatch(setHardWareSelectedData(faults));
	        dispatch(requestDataActions.setRequestSuccess());
			};
		});
    }
}
//曹志强		20170206	获取硬件资产借用入库被选择资产列表 
export function get_hardBorrowAssetOfCode(param) {
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		oData.getHardAssetOfCode(param,function(data){
			var results = data.results;
			if(results.length>0){
					var result = results[0].ASSETSINFO;
					var faults = eval(result);
	        dispatch(setHardWareSelectedBorrowData(faults));
	        dispatch(requestDataActions.setRequestSuccess());
			};
		});
    }
}
//曹志强		20170206	获取硬件资产维修入库被选择资产列表 
export function get_hardRepairAssetOfCode(param) {
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		oData.getHardAssetRepairOfCode(param,function(data){
			var results = data.results;
			if(results.length>0){
					var result = results[0].ASSETSINFO;
					var faults = eval(result);
...
//曹志强		20170206	获取硬件资产借用入库被选择资产列表 
export function get_hardAssetRepairOfCode(param) {
    return dispatch => {
        dispatch(requestDataActions.setRequest());
		oData.getHardAssetRepairOfCode(param,function(data){
			var results = data.results;
			if(results.length>0){
					var result = results[0].ASSETSINFO;
					var faults = eval(result);
	        dispatch(setHardWareSelectedRepairData(faults));
	        dispatch(requestDataActions.setRequestSuccess());
			};
		});
    }
...
//曹志强		20170215	添加硬件资产入库导入
export function edit_hardWareStorageData(data) {
    return (dispatch, getState) => {
        var state = getState();
	      dispatch(requestDataActions.setRequest());
				oData.editHardWareStorage(data,function(data2){
	      dispatch(requestDataActions.setRequestSuccess());
	      	var results = data2.results;
	      	var flag = results[0].FLAG;
	      	if(flag == "true"){
	      		setTimeout(function(){
							document.getElementById('publicMessageModelTitle').innerHTML = "提示"
	      		...
	      		setTimeout(function(){
							document.getElementById('publicMessageModelTitle').innerHTML = "提示"
							document.getElementById('publicMessageModalcontent').innerHTML = "操作失败"
							$('#publicMessageModal').modal('show');
						},100);
	      	}
					dispatch(get_HardWareStorageData(""));
...
//曹志强		20170215	教养绑定硬件资产状态
export function verify_statusForBindAssets(data,param) {
    return (dispatch, getState) => {
        var state = getState();
	      dispatch(requestDataActions.setRequest());
				oData.verifyStatusForBindAssets(data,dispatch,param,function(data2){
		      dispatch(requestDataActions.setRequestSuccess());
		      var results = data2.results;
		      var flag = results[0].FLAG;
		      var errorMsg = results[0].INFO;
					if(flag == "true"){
						dispatch(save_hardWareStorageData(param));
					}else{
						setTimeout(function(){
							document.getElementById('publicMessageModelTitle').innerHTML = "提示"
							document.getElementById('publicMessageModalcontent').innerHTML = "操作失败,原因是："+errorMsg;
							$('#publicMessageModal').modal('show');
						},100);
					}
				});
